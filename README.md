...
# This will be removed in future versions of RoboDK from robodk import PosePP as p
...
r.setFrame(p(0,0,0,0,0,0),-1,r"""UR10e Base""") r.MoveL(p(959.917,-174.15,913.15,-90,0,-90),[0,-116.758,-56.6482,-6.59337,90,- 7.01671e-15],[0,1,0]) r.MoveJ(p(959.917,-174.15,665.425,-90,0,-173.45),[0,-114.81,-62.1019,- 86.5388,90,3.67013e-07],[0,1,0]) r.MoveL(p(1014.27,-174.15,191.996,-90,0,-173.45),[0,-133.078,-82.7014,- 47.6708,90,3.47083e-07],[0,1,0]) r.MoveJ(p(615.062,-174.15,398.403,-90,0,152.659),[5.23048e-07,-93.8684,-110.411,- 93.061,90,4.6462e-07],[0,1,0]) r.MoveJ(p(404.693,-174.15,779.823,-90,0,-170.795),[131.439,-117.436,101.414,- 80.0997,276.888,-48.1924],[1,0,0])
r.ProgFinish(r"""Prog1""") r.ProgSave(r"""C:/Users/Sudharshna/Documents/RoboDK""",r"""Prog1""",True,r"""E:/Ro boDK/Other/VSCodium/VSCodium.exe""")

### Tree


![output](ex.1.1.kin.PNG)

### COORDINATES OF THE MOVEMENTS: 

## coordinate 1:
![output](ex.1.2.kin.PNG)
## coordinate 2:
![output](ex.1.2.kin.PNG)


### SIMULATION RESULTS :
![output](ex.1.4.kin.PNG)
![output](ex.1.5.kin.PNG)
